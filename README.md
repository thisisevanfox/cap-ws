...
- Copy the content from the `.cdsrc.json-with-saas-provisioning` file to `.cdsrc.json` (the only difference is the added line `"cds.xt.SaasProvisioningService": true,`)
- Run `npm run dev`
- Open the [UI5 Web Socket sample application](http://localhost:8080/launchpad#WebSocket-display)
